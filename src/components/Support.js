          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
            <div className='bg-white rounded-xl shadow-2xl'>
              <div className='p-8'>
                ...
                <p className='text-gray-600 text-xl'>llorem alkdkjkldk lkakdkdjk kakdkla kajdkjkajkjvnvlkl lakkjlkalkf lorem alkdkjkldk lkakdkdjk alkdlkdkaklsl kdkndkjdklak kajdkljka kljkadj kja alak  </p>
              </div>
